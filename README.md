...
```
    ...
    Static page generator for GraphQL.js v1.0.0
    ...
    --schemma, -s           Graphql Schema file ["./schema.json"].
    --plugin, -p            Use plugins.
    --no-default-plugins    Dont use default plugins.
...
## [Demo](https://2fd.github.io/graphdoc/)